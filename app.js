...
const BUGS = [
  {
    id: "panda",
    emoji: "🐼",
    name: "NullPointer Panda",
    danger: "alta",
    habitat: "tutoriales de madrugada",
  },
  {
    id: "alpaca",
    emoji: "🦙",
    name: "Async Alpaca",
    danger: "media",
    habitat: "promesas sin resolver",
  },
  {
    id: "iguana",
    emoji: "🦎",
    name: "Indentation Iguana",
    danger: "baja",
    habitat: "python sin spaces",
  },
  {
    id: "shark",
    emoji: "🦈",
  ...
  },
  {
    ...
    name: "Scope Owl",
    danger: "media",
    habitat: "variables fuera de lugar",
  },
  {
    id: "bat",
    emoji: "🦇",
...
document.getElementById("btnTheme").addEventListener("click", () => {
  ...
  setStatus(
    document.body.classList.contains("light") ? "modo día" : "modo noche"
  );
});
